...
"""
HFish 威胁情报自动化生成脚本
功能：从 HFish API 拉取攻击日志，清洗聚合后生成静态 HTML 页面
适配 HFish v2.7.0
"""
...
<head>
    ...
    <title>HFish 威胁情报源 - 自动化蜜罐攻击分析</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ HFish 威胁情报源</h1>
            <p class="update-time">数据时间范围: {{ stats.time_range }} | 最后更新: {{ last_update }}</p>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-label">涉及国家/地区</div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="top-list">
                <div class="list-item">
                    ...
                    <div class="rank-item">
                        <span>{{ ip }}</span>
                        <span class="rank-value">{{ count }} 次</span>
                    </div>
                    {% endfor %}
                </div>
                <div class="list-item">
            ...
            <div class="data-table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="badge">{{ row.get('攻击源IP', '-') }}</span></td>
                            <td>{{ row.get('地理位置', '-') }}</td>
                            <td>{{ row.get('服务类型', '-') }}</td>
                            <td>{{ row.get('端口', '-') }}</td>
                            <td>{{ row.get('蜜罐节点', '-') }}</td>
        ...
        <div class="footer">
            <p>🤖 由 HFish 蜜罐自动采集 · 每6小时更新 · <a href="#" target="_blank">GitHub 仓库</a></p>
            <p style="margin-top: 10px; font-size: 0.8em;">威胁情报自动生成系统 v2.0</p>
        </div>
    </div>
</body>
</html>
